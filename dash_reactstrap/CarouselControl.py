...
class CarouselControl(Component):
    """A CarouselControl component.
...
Available events: """
    ...
    def __init__(self, direction=Component.REQUIRED, onClickHandler=Component.REQUIRED, cssModule=Component.UNDEFINED, directionText=Component.UNDEFINED, className=Component.UNDEFINED, **kwargs):
        ...
        for k in ['direction', 'onClickHandler']:
            if k not in args:
                raise TypeError(
                    'Required argument `' + k + '` was not specified.')
        super(CarouselControl, self).__init__(**args)
        ...
        if(any(getattr(self, c, None) is not None
           ...
           or any(getattr(self, c, None) is not None
            ...
            wilds_string = ', '.join([c+'='+repr(getattr(self, c, None))
                                      ...
                                      for wc_attr in
                                      self._valid_wildcard_attributes])])
            return ('CarouselControl(' + props_string +
